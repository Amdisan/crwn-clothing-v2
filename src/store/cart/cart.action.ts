...
export const setIsCartOpen = withMatcher((bool: boolean): SetIsCartOpen => {return createAction(CART_ACTION_TYPES.SET_IS_CART_OPEN, bool)});
...
export const removeItemsFromCart = (cartItems: CartItem[], cartItemToRemove: CartItem) => {
